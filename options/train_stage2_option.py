...
class TrainStage2Options(BaseStage2Options):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_L1', type=float, default=0, help='weight for |B-G(A, E(B))|')
        self.parser.add_argument('--lambda_z', type=float, default=0, help='weight for ||E(G(random_z)) - random_z||')
        self.parser.add_argument('--lambda_kl', type=float, default=0.5, help='weight for KL loss')
        self.parser.add_argument('--lambda_s_l', type=float, default=5e6, help='weight for local style loss')
        self.parser.add_argument('--lambda_p_l', type=float, default=100, help='weight for local pixel loss')
        self.parser.add_argument('--lambda_GAN_D',type=float,default=0, help='weight for loss_D')
        self.parser.add_argument('--lambda_GAN_l', type=float, default=0, help='weight on local D loss')
        ...
        self.parser.add_argument('--lambda_c', type=float, default=0, help='weight for content loss')
        self.isTrain = True
        # local random block
        self.parser.add_argument('--block_num', type=int, default=5, help='num of random blocks')
        self.parser.add_argument('--min_block_size', type=int, default=64, help='min size of random block')
