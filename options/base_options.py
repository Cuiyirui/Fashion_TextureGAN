...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--nz', type=int, default=128, help='#latent vector')  #code size
        ...
        # models
        self.parser.add_argument('--whether_netB',type=bool,default=True,help='whether diversity is needed')
        ...
        self.parser.add_argument('--nl', type=str, default='relu', help='non-linearfity activation: relu | lrelu | elu')
